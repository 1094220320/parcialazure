"""
Django settings for misitio15 project.
...
SECRET_KEY = 'django-insecure-6t722v9-3doi@w!_x9$qf1+g6w-jx-hzasw*i&2w_xpeufp_%@'
...
WSGI_APPLICATION = 'misitio15.wsgi.application'
